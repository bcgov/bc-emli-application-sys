...
ActiveRecord::Schema[7.1].define(version: 2025_04_10_205003) do
  ...
  create_table "program_classification_memberships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "program_id", "user_group_type_id", "submission_type_id"], name: "index_program_classification_memberships_unique", unique: true
  end
