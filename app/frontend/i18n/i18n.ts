      ...
      translation: {
            ...
            annualHouseholdValues: [
              {
                '1': [
                  'Less than $51,100',
                  'Between $51,100 and $63,900',
                  'Between $63,900 and $102,100',
                  'Greater than $102,100',
                  'Prefer not to disclose',
                ],
                '2': [
                  'Less than $63,600',
                  'Between $63,600 and $79,500',
                  'Between $79,500 and $127,200',
                  'Greater than $127,200',
                  'Prefer not to disclose',
                ],
                '3': [
                  'Less than $78,200',
                  'Between $78,200 and $97,700',
                  'Between $97,700 and $156,300',
                  'Greater than $156,300',
                  'Prefer not to disclose',
                ],
                '4': [
                  'Less than $94,900',
                  'Between $94,900 and $118,600',
                  'Between $118,600 and $189,800',
                  'Greater than $189,800',
                  'Prefer not to disclose',
                ],
                '5': [
                  'Less than $107,600',
                  'Between $107,600 and $134,500',
                  'Between $134,500 and $215,200',
                  'Greater than $215,200',
                  'Prefer not to disclose',
                ],
                '6': [
                  'Less than $121,400',
                  'Between $121,400 and $151,700',
                  'Between $151,700 and $242,700',
                  'Greater than $242,700',
                  'Prefer not to disclose',
                ],
                '7+': [
                  'Less than $135,100',
                  'Between $135,100 and $168,900',
                  'Between $168,900 and $270,200',
                  'Greater than $270,200',
                  'Prefer not to disclose',
                ],
              },
            ],
        ...
        permitApplication: {
          ...
          show: {
            ...
            revision: {
              ...
              maxCharacters: '{{count}} / {{max}} characters',
        ...
        energySavingsApplication: {
          ...
          show: {
            ...
            applicationStatusTitle: 'Timeline',
            applicationSubmitted: '{{submissionType}} was submitted on {{date}}',
            applicationScreenedIn: '{{submissionType}} was screened in on {{date}}',
            applicationApproved: '{{submissionType}} was approved on {{date}}',
            applicationIneligible: '{{submissionType}} was marked ineligible on {{date}}',
        ...
        site: {
          ...
          helpDrawer: {
            ...
            emailTitle: 'Email',
            emailAddress: 'BetterHomesESP@CLEAResult.com',
            contractorEmail: 'ESPcontractorSupport@CLEAResult.com',
            contractorEmailAriaLabel: 'Email us at ESPcontractorSupport@CLEAResult.com.',
        ...
        contractor: {
          ...
          programResources: {
            ...
            resources: {
              ...
              miniSplitHeatPumps: 'Mini-split, multi-split, central and dual fuel heat pumps list',
              airToWaterHeatPumps: 'Air-to-water heat pumps list',
              heatPumpWaterHeaterList: 'Heat pump water heater list',
              windowsAndDoorsList: 'Windows and doors list',
              ventilationList: 'Ventilation list',
