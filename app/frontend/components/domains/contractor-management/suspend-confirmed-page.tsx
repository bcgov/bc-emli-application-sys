...
export const SuspendConfirmedPage = observer(function SuspendConfirmedPage() {
  ...
  return (
    <Container maxW="900px" py={20} pb={10} as="main">
      <VStack align="center" spacing={8} w="full" role="region" aria-live="polite">
        <VisuallyHidden>Warning: Contractor has been suspended</VisuallyHidden>
        ...
        <VStack spacing={2}>
          ...
          <Heading ref={headingRef} as="h1" fontSize="32px" textAlign="center" color="theme.blueAlt" tabIndex={-1}>
            {t('contractor.suspend.confirmed.title', 'Contractor suspended.')}
          </Heading>
        </VStack>
